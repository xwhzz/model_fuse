...
# Copy from https://github.com/microsoft/onnxruntime/blob/main/onnxruntime/python/tools/symbolic_shape_infer.py
...
if __name__ == "__main__":
    ...
    if args.output and out_mp:
        if args.save_as_external_data:
            ...
            # onnx.save_model(out_mp, args.output, save_as_external_data=True, all_tensors_to_one_file=True, location="filename", size_threshold=1024, convert_attribute=False)
        else:
